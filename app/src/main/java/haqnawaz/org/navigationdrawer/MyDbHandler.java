...
//    }
    ...
    public ArrayList<tayah> getSurahWithTranslation(int id,String urdu,String Eng)
    {
        ArrayList<tayah> t= new ArrayList<tayah>();
        SQLiteDatabase db=this.getReadableDatabase();
        String select_query="SELECT ArabicText,"+urdu+","+Eng+" FROM "+ "tayah where SuraID="+id;
        ...
        if(cursor.moveToFirst()){
            do {
                if(cursor!=null)
                {
                    tayah e= new tayah(0,0,cursor.getString(0),cursor.getString(1),cursor.getString(2),0,0);
                    t.add(e);
...
//        input=an.getOutput();
        ...
        if(cursor.moveToFirst()){
            do {
                if(cursor!=null)
                {
                    tayah e= new tayah(0,0,cursor.getString(3),cursor.getString(4),cursor.getString(6),0,0);
                    t.add(e);
